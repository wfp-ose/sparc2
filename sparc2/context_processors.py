...
from sparc2.enumerations import MONTHS_NUM, MONTHS_LONG, MONTHS_SHORT3, MONTHS_ALL, DAYSOFTHEWEEK, SPARC_HAZARDS_CONFIG, SPARC_BREADCRUMBS
...
def sparc2(request):
    ...
    defaults = dict(
        ...
        SPARC_STATIC_DEPS=settings.SPARC_STATIC_DEPS,
        SPARC_DNS_PREFETCH=settings.SPARC_DNS_PREFETCH,
